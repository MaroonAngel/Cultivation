package net.maroonangel.cultivation.lib.dispenser;
...
public class SeedDispenserBehavior extends BlockPlacementDispenserBehavior {
    ...
    protected ItemStack dispenseSilently(BlockPointer blockPointer_1, ItemStack itemStack_1) {
        ...
        if (item_1 instanceof BlockItem) {
            ...
            if (!this.isSuccess()) {
                this.setSuccess(((BlockItem) item_1).place(new AutomaticItemPlacementContext(blockPointer_1.getWorld(), blockPos_1, direction_1, itemStack_1, direction_2)) == ActionResult.SUCCESS);
            }
        }
